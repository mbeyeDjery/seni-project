...
import fr.app.seni.auth.gestion.config.KeycloakCredentials;
...
public class UserService {
    ...
    public AppUserDto createUser(AppUserDto appUser) {
        ...
        } else if (appUserService.findByUsername(appUser.getUsername(), AppUserGroup.MANAGER) != null) {
            throw new CustomException("Ce login ne peut pas être utilisé", HttpStatus.CONFLICT);
        } else if (appUserService.findByEmail(appUser.getEmail(), AppUserGroup.MANAGER) != null) {
            throw new CustomException("Un utilisateur avec cet email existe déja", HttpStatus.CONFLICT);
        }else if (appUserService.findByTelephone(appUser.getTelephone(), AppUserGroup.MANAGER) != null) {
    ...
    public List<AppUserDto> getAllUsers() {
        List<AppUserDto> appUsers = appUserService.findAll(AppUserGroup.MANAGER);
