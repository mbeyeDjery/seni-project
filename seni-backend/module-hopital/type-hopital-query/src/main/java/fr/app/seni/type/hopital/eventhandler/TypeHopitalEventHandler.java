package fr.app.seni.type.hopital.eventhandler;
...
public class TypeHopitalEventHandler {
    ...
    protected void onCreatedEvent(TypeHopitalCreatedEvent event) {
        event.getTypeHopitalDto().setIdTypeHopital(event.getId());
        typeHopitalService.create(event.getTypeHopitalDto());
    }

    @EventHandler
    @Transactional
    protected void onUpdatedEvent(TypeHopitalUpdatedEvent event) {
        typeHopitalService.update(event.getTypeHopitalDto());
    }
